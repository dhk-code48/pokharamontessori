...
export const SubCategoryForm: React.FC<SubCategoryFormProps> = ({ initialData, categories }) => {
  ...
  const onSubmit = async (data: SubCategoryFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/${params.siteId}/subcategories/${params.subcategoryId}`, data);
      } else {
        await axios.post(`/api/${params.siteId}/subcategories`, data);
      }
      router.refresh();
      router.push(`/${params.siteId}/subcategories`);
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.siteId}/subcategories/${params.categoryId}`);
      router.refresh();
      router.push(`/${params.siteId}/subcategories`);
